...
%    mplpol.r.ap_copol(lte1) = mplpol.ap.copol(mplpol.ap.range>0&mplpol.ap.range<=1); 
   ...
   if isNaN(cop_ap_bg)
       cop_ap_bg = mean(mplpol.r.ap_copol(mplpol.range<0));
   end
   crs_ap_bg = mean(mplpol.r.ap_crosspol(mplpol.range>45&mplpol.range<50));
   if isNaN(crs_ap_bg)
       crs_ap_bg = mean(mplpol.r.ap_crosspol(mplpol.range<0));
   end
   figure_(51); plot(mplpol.ap.range, mplpol.ap.copol-cop_ap_bg,'o',mplpol.range, mplpol.r.ap_copol-cop_ap_bg,'r-',...
       mplpol.ap.range, mplpol.ap.crosspol-crs_ap_bg,'o',mplpol.range, mplpol.r.ap_crosspol-crs_ap_bg,'k-'); 
