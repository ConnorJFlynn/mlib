...
% Modified on 2009_12_22 to reprocess data for Jochen and Ross
mirror = tnmpl_mir;
base = 'F:\case_studies\tnmpl\mpl\processing\';
if ~exist('F:\case_studies\tnmpl\mpl\four','dir')
   mkdir(['F:\case_studies\tnmpl\mpl\four']);
end
bundle = ['F:\case_studies\tnmpl\mpl\four\'];
...
fid = fopen('F:\case_studies\tnmpl\mpl\processing\mir_pos.20060831_20060929.dat', 'r');
