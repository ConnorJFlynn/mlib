...
cloudflagbot = -0*ones(zmax, size(backscatter, 2));     % Initialize the cloud fla
cloudflagtop = -0*ones(zmax, size(backscatter, 2));     % Initialize the cloud fla
...
% Sometimes it is nice to plot the actual PBL height on figure 1
