  mpl_inarg.in_dir = 'H:\cold_storage\zli_Xianghe_mplrawdata\zli_Xianghe_mplrawdata\raw\';
  mpl_inarg.tla = 'Xianghe';
  ...
  mpl_inarg.tla = 'Xianghe';
   ...
   mpl_inarg.fig = 1;
   mpl_inarg.vis = 'off';
   mpl_inarg.cv_log_bs = [1,5];
   mpl_inarg.plot_ranges = [25,15,5,2];
   
   %%
%     [status,polavg] = batch_fastmpl2mat_X(mpl_inarg.in_dir);
