function polavg = plot_pola_log_bs_(polavg,inarg)
...
% This is a working version that saves figs for both the bi-plot and a transparency plot
% As of 2022-10-29 I am working on a new version that replaces the dpr panel with the
