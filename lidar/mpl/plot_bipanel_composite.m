function outs = plot_bipanel_composite(X,Y,Z1,Z2,cv1,cv2,cmap,v)
% outs = plot_bipane_composite(X,Y,Z1,Z2,cv1,cv2,cmap,v)
% 
...
while loop
   ...
   ax(1) = subplot(2,1,1,'position',[0.10    0.5838    0.71    0.3412]); 
   imagegap(x, y, z1);
   cb1 = colorbar;
      caxis(cv_log_bs);
