...
%     end
    ...
    bkgnd_cool_std(t) = fread(fid, 1, 'float32');% Background signal standard deviation in counts/microsecond
...
%     %%
%     fseek(fid, mark, -1);
     first_bin(t) = fread(fid, 1, 'uint8');
    dump = fread(fid, 8, 'char');% Future expansion    
