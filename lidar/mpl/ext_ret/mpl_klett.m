function [alpha_a, beta_a, tau_new] = mpl_klett(range, X, tau_layer, lidar_C, beta_R, Sa)
% [beta_a, tau_new] = mpl_klett(range, X, tau_layer, lidar_C, alpha_R, beta_R, Sa)
% returns aerosol backscatter coef beta and new tau_aerosol
% requires:
% range
% X: uncalibrated attenuated lidar profile, 
% tau_layer:layer aerosol optical depth at lidar wavelength
