function [base, top,hcb,hct,ii] = cloud_zwang2(height, prof, ref, in_time)
% [bs tp] = cloud_zwang(height, prof, ref, in_time);
%  This routine calls Zhien Wang's cloud detection algorithm written in
%  Fortan and compiled as a mex file MPLbase_siv1.  The height and lidar 
...
% [bs, tp] = MPLbase_sub1(in_time,50 , prof(1:50) ,height(1:50) ,
% ref(1:50));
[base, top,hcb,hct,ii] = MPLbase_siv1(in_time,n_height , prof ,height , ref);
