function [status] = raw_to_data0(old_cdfid, new_cdfid)
...
% This process accepts two open cdfids; one for an existing lidar file and one for 
% a new lidar file defined in new_def_nc.  It then populates new_cdfid based with values
% from old_cdfid, except the 3-D variables (detector counts) are cast into float. 
% In addition, the static field 'data_level', and the global attribute 'history' 
% are both added. 
