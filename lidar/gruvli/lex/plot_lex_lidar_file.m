function status = plot_lex_lidar_file(lidar, pname);
% status = plot_lex_lidar_file(lidar, pname, fname);
% Given a PARSL lex lidar structure, several plots are generated and
% saved as .png files.
if nargin==0
