function [status] = plot_lex_lidar_files;
% [status] = process_lex_lidar_files;
...
disp('Please select a directory containing Lexington PARSL Lidar netcdf files.');
[dirlist, pname] = dir_list('lex*.nc');
...
for i = 1:length(dirlist);
    ...
    if ncid>0
       ...
       status = plot_lex_lidar_file(lidar, out_dir);
       ncmex('close',ncid)
       clear lidar
    end
