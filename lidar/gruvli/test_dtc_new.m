function [status] = test_dtc_new(cdf_file);
...
status = ncmex('VARDEF', cdfid, 'copol_532nm_SNR', 'NC_DOUBLE', ndims, dims);
    value = 'Signal to Noise Ratio of copolarized elastic backscatter at 532nm';
...
status = ncmex('VARDEF', cdfid, 'depol_532nm_log', 'NC_DOUBLE', ndims, dims);
    value = 'Natural Log of total detected counts of depolarized elastic backscatter return per bin per averaging interval.';
...
status = ncmex('VARDEF', cdfid, 'depol_532nm_SNR', 'NC_DOUBLE', ndims, dims);
    value = 'Signal to Noise Ratio of depolarized elastic backscatter at 532nm';
