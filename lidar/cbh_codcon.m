function mpl = cbh_codcon(mpl, clear_sky_avg, thresh);
...
numer = mpl.rawcts(mpl.r.lte_20,:) - (ones(size(mpl.r.lte_20))*mpl.hk.bg) - (clear_sky_avg(mpl.r.lte_20)*ones(size(mpl.time)));
