...
while ~isempty(mini)
   % Look for front panel Tr readings  <=1 and >.99.
      newf_i = mini - 1 + find(psap3w.Tr_red(mini:end)>.96&psap3w.Tr_red(mini:end)<=1 & ...
      psap3w.Tr_grn(mini:end)>.96&psap3w.Tr_grn(mini:end)<=1 & ...
      psap3w.Tr_blu(mini:end)>.96&psap3w.Tr_blu(mini:end)<=1, 1,'first');
