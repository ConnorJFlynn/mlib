...
xap_Trs = [];
while isempty(xap_Trs)&&~isstruct(xap_Trs)
   while xap.NumBytesAvailable<len; end
   xap_Trs = xap_1line_(readline(xap));
end
...
if isafile([xap_path,white_filter])
   ...
   flush(xap,'output'); writeline(xap,'main');pause(.05);
   flush(xap); writeline(xap,'hide'); pause(.05);
   flush(xap); writeline(xap,'hide');pause(.05);
   flush(xap);
   writeline(xap,'show');pause(.05);
...
xap_Trs.Trs_blu = xap_Trs.signal_blue./white.blue';
xap_Trs.Trs_grn = xap_Trs.signal_green./white.green';
xap_Trs.Trs_red = xap_Trs.signal_red./white.red';

% Tr_blu([2,4,6,8]) = xap_Trs.Trs_blu([2,4,6,8])./xap_Trs.Trs_blu(10);
% Tr_blu([1,3,5,7]) = xap_Trs.Trs_blu([1,3,5,7])./xap_Trs.Trs_blu(9);
% Tr_grn([2,4,6,8]) = xap_Trs.Trs_grn([2,4,6,8])./xap_Trs.Trs_grn(10);
% Tr_grn([1,3,5,7]) = xap_Trs.Trs_grn([1,3,5,7])./xap_Trs.Trs_grn(9);
% Tr_red([2,4,6,8]) = xap_Trs.Trs_red([2,4,6,8])./xap_Trs.Trs_red(10);
% Tr_red([1,3,5,7]) = xap_Trs.Trs_red([1,3,5,7])./xap_Trs.Trs_red(9);
...
while ~done
   ...
   while toc<update & ~done
      ...
      if length(xap_line{1})>450
         ...
         xap_Trs_ =  cat_timeseries(xap_Trs_,xap_Trs );% cat_xap( xap_Trs_,xap_Trs);
      end
   ...
   clear Tr_blu Tr_grn Tr_red
   Tr_blu([2,4,6,8],:) = xap_Trs_.Trs_blu([2,4,6,8],:)./xap_Trs_.Trs_blu(10,:);
   Tr_blu([1,3,5,7],:) = xap_Trs_.Trs_blu([1,3,5,7],:)./xap_Trs_.Trs_blu(9,:);
   Tr_blu([9,10],:) = xap_Trs_.Trs_blu([9,10],:)./mean(xap_Trs_.Trs_blu([9,10],:),2);
   Tr_grn([2,4,6,8],:) = xap_Trs_.Trs_grn([2,4,6,8],:)./xap_Trs_.Trs_grn(10,:);
   Tr_grn([1,3,5,7],:) = xap_Trs_.Trs_grn([1,3,5,7],:)./xap_Trs_.Trs_grn(9,:);
   Tr_grn([9,10],:) = xap_Trs_.Trs_grn([9,10],:)./mean(xap_Trs_.Trs_grn([9,10],:),2);
   Tr_red([2,4,6,8],:) = xap_Trs_.Trs_red([2,4,6,8],:)./xap_Trs_.Trs_red(10,:);
   Tr_red([1,3,5,7],:) = xap_Trs_.Trs_red([1,3,5,7],:)./xap_Trs_.Trs_red(9,:);
   Tr_red([9,10],:) = xap_Trs_.Trs_red([9,10],:)./mean(xap_Trs_.Trs_red([9,10],:),2);
   Tr_BGR = NaN([3,length(xap_Trs_.time)]);
   for spot = 8:-1:1
      spot_ = xap_Trs_.spot == spot;
      Tr_BGR(:,spot_) = [Tr_blu(spot,spot_);Tr_grn(spot,spot_);Tr_red(spot,spot_) ];
   end
   ...
   %
   if any(Tr_BGR(:,end)<Tr_min)
      if (xap_Trs.spot == 8) && any(Tr_BGR(:,end)<Tr_min) % On spot 8 , filter exhausted
         white = load([xap_path,white_filter]);
         white.loaded = true;
   ...
   if ~done
      ...
      if ~isavar('an')
         ...
         if xap_Trs_.spot(end)>0
            an(6).String = sprintf('Tr: %1.3f',Tr_BGR(3));
            an(7).String = sprintf('Tr: %1.3f',Tr_BGR(2));
            an(8).String = sprintf('Tr: %1.3f',Tr_BGR(1));
         end
         if length(an)==9
            if isfield(white,'loaded')&&  white.loaded
      ...
      plot(Hs, [Tr_BGR],'.-'); legend('Tr (red)','Tr (grn)','Tr (blu)'); ylabel('Tr [unitless]');
   ...
   if (max(Hs)-min(Hs))>7
      ...
      xap_Trs.Tr_BGR(:,dmp) = [];xap_Trs_.Tr(:,dmp) = [];
   end
...
while ~done
   ...
   elseif men ==2
      ...
      if mn ==1
         ...
         flush(xap); writeline(xap,['spot=1']);readline(xap);
         white_dat =  ['white.',datestr(now,'yyyymmdd.HHMM'),'.dat'];
         white_filter = write_white(xap, xap_path, white_dat);
         white = load([xap_path,white_filter]);
         white.Tr_min = 0.7;
