function [Ba_V,ii_,k0,k1,h0,h1,s,ssa] = compute_Virkkula(Tr,Bs,Ba_raw,N)
...
% or as a 5-element vector of doubles specify each parameter specifically
...
% 2022-11-20: Connor Flynn, modified to accept specified parameter values
