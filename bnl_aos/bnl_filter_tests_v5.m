...
function bnl_psap_filter_tests_v5(ss)
...
psap_046 = load(getfullname([outdir,'*.mat'],'filter_study_out'));
psap_077 = load(getfullname([outdir,'*.mat'],'filter_study_out'));
psap_090 = load(getfullname([outdir,'*.mat'],'filter_study_out'));
psap_092 = load(getfullname([outdir,'*.mat'],'filter_study_out'));
psap_107 = load(getfullname([outdir,'*.mat'],'filter_study_out'));
psap_110 = load(getfullname([outdir,'*.mat'],'filter_study_out'));
