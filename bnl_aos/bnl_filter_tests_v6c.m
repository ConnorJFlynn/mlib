...
function bnl_psap_filter_tests_v6c(ss)
...
% 6c modified to handle last several days of tests
if ~isavar('ss')
   ss = 60;
end
ss = 60;
...
mint = max([mint,datenum('2018-11-20 21:00','yyyy-mm-dd HH:MM')]);datestr(mint)
maxt = min([maxt, datenum('2018-11-27 14:59','yyyy-mm-dd HH:MM')]); datestr(maxt)
