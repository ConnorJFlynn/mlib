...
low_signal = neph_grid.Bs_B_sm<5 || neph_grid.Bs_G_sm<5;
psapo_grid.Ba_B_Bond(low_signal) = psapo_grid.Ba_B_sm_Weiss(low_signal);

low_signal = neph_grid.Bs_B_sm<5 || neph_grid.Bs_R_sm<5;
...
low_signal = neph_grid.Bs_G_sm<5 || neph_grid.Bs_R_sm<5;
...
data_in.Ba_B = psapo_grid.Ba_B_Bond(good).*corr_STP_to_ambient; info.Ba_B = ['1/Mm, aerosol absorption (blue)']; form.Ba_B = '%6.3f';
data_in.Ba_G = psapo_grid.Ba_G_Bond(good).*corr_STP_to_ambient; info.Ba_G = ['1/Mm, aerosol absorption (green)']; form.Ba_G = '%6.3f';
data_in.Ba_R = psapo_grid.Ba_R_Bond(good).*corr_STP_to_ambient; info.Ba_R = ['1/Mm, aerosol absorption (red)']; form.Ba_R = '%6.3f';
rev = '0';
