...
% FILENAME INFO
dataID      = 'PSAP';   %DATA ID (1st part of filename)
...
NormalComments = {...
    ...
    'ASSOCIATED_DATA: This file contains the data from the PSAP in 4 sec interval and includes corrections requiring data from the Neph and IWG1 files.';...
    'INSTRUMENT_INFO: The PSAP is after iso-kinetic inlet. The filter-loading and scattering corrections Bond 1999, Anderson & Ogren 1998, Ogren 2010 are all applied';...
    'DATA_INFO: Data reported at 4-s interval but transmittances and flows have been smoothed with a 32-s boxcar filter.';...
    'UNCERTAINTY: Calibration uncertainty is +/-10 percent but this is poorly known.';...
    'ULOD_FLAG: -7777';...
    'ULOD_VALUE: N/A';...
    'LLOD_FLAG: -8888';...
    'LLOD_VALUE: N/A';...
    ...
    'OTHER_COMMENTS: Absorption coefficients initially at STP conditions (0 C, 1013.5 Pa) have been corrected to ambient temperature and pressure.';...
    };
