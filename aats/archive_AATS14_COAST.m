function [ntimwrt,resultfile]=archive_AATS14_COAST(filename,dataarchive_dir,FlightNo,UT,day,month,year,lambda,V0,NO2_clima,Loschmidt,...
...
comments_other={'OTHER_COMMENTS: Start_UTC may only be accurate to 1-2 seconds. Reflection off aircraft wing during turns occasionally resulted in'
                'incorrect measurements in selected channels. Some but not all of these observations have been removed from the data set; '
...
fprintf(fid,'0\n');
fprintf(fid,'Elapsed seconds from 0 hours UTC on day given by DATE: Start_UTC\n');
...
fprintf(fid,'filler_1\n');
fprintf(fid,'filler_2\n');
...
fprintf(fid,'Cloud screen flag (0=possible cloud contamination, 1=no contamination): cld_scr\n');
...
fprintf(fid,'Start_UTC  filler      filler   Latitude  Longitude    GPS_alt    P_alt  Stat_p     CWV      unc_CWV   O3_col   cld_scr    a2       a1       a0     AOD354    AOD380    AOD452    AOD500    AOD520    AOD605    AOD675    AOD779    AOD864   AOD1019   AOD1236   AOD2139  u_AOD354  u_AOD380  u_AOD452  u_AOD500  u_AOD520  u_AOD605  u_AOD675  u_AOD780  u_AOD864  u_AOD1019 u_AOD1236 u_AOD2139\n')
