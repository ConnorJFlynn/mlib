function hh = loglog_errorbar(xmin, xmax, ymin, ymax, x, y, l,u,symbol)
...
%   $Revision: 1.1 $  $Date: 2013/12/11 00:49:56 $
...
%xl = x - tee;
%xr = x + tee;
tee = 0.60*log(xmax/xmin)/100;  % make tee .0075 log(x-distance) for error bars
xl = x*10^-tee;
xr = x*10^tee;
ytop = y + u;
%ybot = y - l;
