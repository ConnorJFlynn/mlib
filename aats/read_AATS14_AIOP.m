...
switch lower(product)
    case 'h2o_profile'
        [filename,pathname]=uigetfile('c:\beat\data\Aerosol IOP\Results_v2.1\*_pw.asc','Choose file', 0, 0);
    ...
    case 'aod_normal'
        [filename,pathname]=uigetfile('c:\beat\data\Aerosol IOP\Results_v2.1\*_r.asc','Choose file', 0, 0);
        fid=fopen([pathname filename]);
        fgetl(fid);
        title1=fgetl(fid);
        ...
        a0=data(38,:); 
    case 'aod_profile'
        [filename,pathname]=uigetfile('c:\beat\data\aerosol iop\Results_v2.1\*p.asc','Choose file', 0, 0);
        fid=fopen([pathname filename]);
        fgetl(fid);
        title1=fgetl(fid);
