...
% fid=fopen('c:\beat\data\xsect\Ames14#1_safari_wvl.asc');
 ...
 figure(1)
 subplot(2,1,2)
 semilogy(wvl,Tau_Total,wvl,Tau_Aero,wvl,Tau_Rayleigh,wvl,Tau_H2O,wvl,Tau_Ozone,wvl,Tau_CO2,wvl,Tau_CO,wvl,Tau_CH4,wvl,Tau_N2O,wvl,Tau_O2,wvl,Tau_NH3,wvl,Tau_N0,wvl,Tau_NO2,wvl,Tau_SO2)
 xlabel('Wavelength[nm]','FontSize',14);
 ylabel('ln(1/T), "Optical Depth"','FontSize',14);
 legend(col_head(1,:),col_head(9,:),col_head(8,:),col_head(2,:),col_head(4,:),col_head(13,:),col_head(14,:),col_head(15,:),col_head(16,:),col_head(17,:),col_head(18,:),col_head(19,:),col_head(20,:),col_head(21,:));
 set(gca,'ylim',[1e-4 2])
 set(gca,'xlim',[0.30 2.2])
 set(gca,'xtick',[0.30:0.1:2.2]);
 hold on
 semilogy(wvl_AATS14,response,'k','LineWidth',1);
 hold off
 set(gca,'FontSize',14)
 grid off
