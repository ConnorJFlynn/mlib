...
% Adapted to fork for several gases Beat Schmid 1/2001
% Adapted for Tropo and LBLRTM 6.01 Beat Schmid 8/2002 

path(path,'/home/bschmid/Matlab')
pfad_matlab='/home/bschmid/Matlab';
n_gas=1; %Number of Gases considered see LBLRTM description

switch mode
case 1
	% path defintion
	pfad_read='/home/bschmid/LBLRTM/TAPE5';
	pfad_lbl='/home/bschmid/LBLRTM/lblrtm';
	pfad_save='/home/bschmid/LBLRTM/TAPE6';
	eval(['cd ',pfad_read])
...
case 2
	% path defintion
	pfad_read='/home/bschmid/LBLRTM/TAPE6';
	pfad_save='/home/bschmid/LBLRTM/mTAPE6';
	eval(['cd ',pfad_read])
