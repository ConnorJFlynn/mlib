function ACCP_SITA_Sept_pngs_ppts_v23(gv, gv2, do_plot)
% ACCP_SITA_Sept_pngs_ppts_v23(gv, gv2, do_plot)
...
QISadj = apply_Sept_adj_v2_to_QIS(QIS);
...
OQS_C0 = apply_OWCs_v2(QIS,false); % 
...
% results only.
OQS_C0 = apply_OWCs_v2(QISadj,true); % Apply objective weights after reviewer adjustment
OQS_C1 = apply_OWCs_C1_v1(QISadj,true); %Apply objective weights with C1
