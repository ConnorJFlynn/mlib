function [OQS] = apply_OWCs_C0_v1_by_grp(QIS,out)
% OQS = apply_OWCs_C0_v1_by_grp(QIS,out)
...
% NAD from mean of NADBC0 obs[2] and NADLC0 obs[1]
% NAN from mean of NANLC0 obs[3]
...
for OO = 1:4
    for sfc = 1:2
        ...
        for H = gv
            ...
            meanOQ_NADLC0 = meannonan(new_OQ1.*ONAN)./mean(OCWs); % These are mean Qs for this GV and Objective weights.
            ...
            OQS(H,:,:,2,sfc,OO) = [new_OQ1./mean(OCWs); meanOQ_NANLC0];
