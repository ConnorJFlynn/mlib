function ACCP_pngs_ppts_v16(gv, gv2)
...
% v16: Apply adjustments, prepare for outputting 
...
[QI_adj] = plot_ACCP_Q_adjust_V2(QIS,gv,'RES5', [PPT_path pptname3]);
...
for pl = pltf:-1:1
    write_AQS(QI_adj(:,:,pl,:),pltf(pl));
end


plot_ACCP_QMR_V13(QIS,MER,RMS,gv,'LNDD','RES5', [PPT_path pptname]);
