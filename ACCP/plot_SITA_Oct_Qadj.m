function [Qall, Qadj] = plot_SITA_Oct_Qadj(QIS,MER,RMS,gv,obs,reso,pptname)
% plot_SITA_Oct_Qadj(QIS,MER,RMS,gv,obs,reso,pptname)
...
% Connor: I don't think this handles cirrus 1 C1 cases.
