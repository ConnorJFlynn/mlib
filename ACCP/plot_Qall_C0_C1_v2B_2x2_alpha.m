function plot_Qall_C0_C1_v2B_2x2_alpha(Qall,pptname)
% Qall = plot_Qall_C0_C1_v2B_4x2_alpha(Qall,pptname)
...
for sfc = 1:length(srfc)
    ...
    set(gca,'XTickLabelRot',0); set(gca,'FontSize',10);
    yl = ylabel({'(NADBC0+NADLC0)/2 + adj';'(NADBC0+NADLC1)/2 + adj'}); set(yl,'rotation',90); 
