function ACCP_SITA_Sept_pngs_ppts_v20(gv, gv2)
...
% V20: in progress, incorporate cirrus scores
% To do: 

%   Replicate 
% Calls:
%   read_all_SITA_Sept_samplefiles_v6
...
[QIS, MER, RMS,VERS,files] = read_all_SITA_Sept_samplefiles_v6(ACCP_set);
