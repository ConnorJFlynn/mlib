function ACCP_pngs_ppts_v10(gv, gv2)
...
if isadir([ACCP_set, 'M1',filesep])
    ...
    saveas(gcf,[ACCP_pngs,png_name2]);close(gcf);
    ppt_add_slide_no_title([PPT_path pptname], [ACCP_pngs,png_name2]);
    plot_ACCP_cases_V5(QIS,MER,RMS,gv2,'LNDD','RES1', [PPT_path pptname]);
    plot_ACCP_cases_V5(QIS,MER,RMS,gv2,'LNDV','RES1', [PPT_path pptname]);
    plot_ACCP_cases_V5(QIS,MER,RMS,gv2,'OCEN','RES1', [PPT_path pptname]);
