function plot_ACCP_QMR_V15(QIS,MER,RMS,gv,sfc,reso,pptname)
% plot_ACCP_QMR_V15(QIS,MER,RMS,gv,sfc,reso)
...
for H = gv
    ...
    for L=1:3 % obs counter obs = ["NAD", "NAN", "OND"];
        ...
        new_QIS = [newQIS;meanQ; weighted_Q];
        subplot(3,3,1+3*(L-1))
        ...
        set(gca,'XTickLabel',{'NLP-DRS','NLS-DRS','NGE-DRS','OUX-DRS',...
            'NLB-ICA','OUX-ICA','NLS-SPA','NGE-SPA','mean','weighted' })
