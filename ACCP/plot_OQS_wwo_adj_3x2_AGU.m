...
layr_x = ["AAOD UV col","AAOD Vis Col"];
prof_x= {"AABS UV above pbl","AABS VIS above pbl"};
...
bb = bar([1:length(layr)],squeeze(OQSadj(layr,:,1,srfc,2)),'barwidth',.7,'edgecolor','none'); ylim([-.15,1]);
hold('on');sq(1).ColorOrderIndex = 1;
bb = bar([1:length(layr)],squeeze(OQSadj(layr,:,1,srfc,2))-squeeze(OQS(layr,:,1,srfc,2)),'barwidth',.3,'edgecolor','k'); ylim([-.1,1]);
...
bar([1:length(prof)],squeeze(OQSadj(prof,:,1,srfc,2)),'barwidth',.7,'edgecolor','none'); ylim([-.1,1]);
...
bar([1:length(layr)],squeeze(OQSadj(layr,:,2,srfc,2)),'barwidth',.7,'edgecolor','none'); ylim([-0.1,1]);
...
bar([1:length(prof)],squeeze(OQSadj(prof,:,2,srfc,2)),'barwidth',.7,'edgecolor','none'); ylim([-0.1,1]);
...
bar([1:length(layr)],squeeze(OQSadj(layr,:,3,srfc,2)),'barwidth',.7,'edgecolor','none'); ylim([-0.1,1]);
...
bar([1:length(prof)],squeeze(OQSadj(prof,:,3,srfc,2)),'barwidth',.7,'edgecolor','none'); ylim([-0.1,1]);
...
n_str = '';n = 1;
fname = [ACCP_pngs,'OQS_and_adj_',SFC{srfc},'_AGU.png'];
while isafile(fname)
    n = n+1; n_str = ['.',num2str(n)];
    fname = [ACCP_pngs,'OQS_and_adj_',SFC{srfc},n_str,'_AGU.png'];
end
saveas(gcf,fname);
pause(2)
close(gcf);
...
hold('on');sq(1).ColorOrderIndex = 1;
bar([1:length(layr)],squeeze(OQS(layr,:,1,srfc,2)),'barwidth',.7,'edgecolor','none','facealpha',.4); 
ylim([0,1]);
set(gca,'position',[0.0669    0.6885    0.3753    0.2365]);
set(gca,'xtick',[1:length(prof)]);set(gca, 'ytick',[0:.2:1])
set(gca,'XTickLabel',xt); %set(sql(2),'xaxislocation','top');
...
lg = legend('SSP0','SSP1','SSP2','SSG3','location','northwest');
hold('on');sq(2).ColorOrderIndex = 1;
bar([1:length(prof)],squeeze(OQS(prof,:,1,srfc,2)),'barwidth',.7,'edgecolor','none','facealpha',.4); 
ylim([0,1]);
set(gca,'position',[0.4558    0.6885    0.4792   0.2365]);
set(gca,'xtick',[1:length(prof)]);set(gca, 'ytick',[0:.2:1])
set(gca,'XTickLabel',xtt); %set(sql(2),'xaxislocation','top');
...
hold('on');sq(3).ColorOrderIndex = 1;
bar([1:length(layr)],squeeze(OQS(layr,:,2,srfc,2)),'barwidth',.7,'edgecolor','none','facealpha',.4); ylim([0,1]);
set(gca,'position',[0.0669     0.421    0.3753   0.2365]);
set(gca,'xtick',[1:length(layr)]);set(gca, 'ytick',[0:.2:1])
set(gca,'XTickLabel',xt); %set(sql(2),'xaxislocation','top');
set(gca,'XTickLabelRot',0); set(gca,'FontSize',10);
...
hold('on');sq(4).ColorOrderIndex = 1;
bar([1:length(prof)],squeeze(OQS(prof,:,2,srfc,2)),'barwidth',.7,'edgecolor','none','facealpha',.4); ylim([0,1]);
set(gca,'position',[0.4558    0.421    0.4792   0.2365]);
set(gca,'xtick',[1:length(prof)]);set(gca, 'ytick',[0:.2:1])
set(gca,'XTickLabel',xtt); %set(sql(2),'xaxislocation','top');
set(gca,'XTickLabelRot',0); set(gca,'FontSize',10);
...
hold('on');sq(5).ColorOrderIndex = 1;
bar([1:length(layr)],squeeze(OQS(layr,:,3,srfc,2)),'barwidth',.7,'edgecolor','none','facealpha',.4); ylim([0,1]);
set(gca,'position',[0.0669    0.1300    0.3753    0.2365]);
% set(gca,'position',[0.1300    0.1100    0.3347    0.2157]);
set(gca,'xtick',[1:length(layr)]);set(gca, 'ytick',[0:.2:1])
set(gca,'XTickLabel',layr_x); %set(sql(2),'xaxislocation','top');
...
hold('on');sq(6).ColorOrderIndex = 1;
bar([1:length(prof)],squeeze(OQS(prof,:,3,srfc,2)),'barwidth',.7,'edgecolor','none','facealpha',.4); ylim([0,1]);
% set(gca,'position',[0.6293    0.7357    0.3301    0.18]);
set(gca,'position',[0.4558     0.1300     0.4792    0.2365]);
set(gca,'xtick',[1:length(prof)]);set(gca, 'ytick',[0:.2:1])
set(gca,'XTickLabel',prof_x); %set(sql(2),'xaxislocation','top');
...
set(mt.th,'fontsize',15,'position',[0.5000    1.0400]);
n_str = '';n = 1;
fname = [ACCP_pngs,'OQS_wwo_adj_alpha_',SFC{srfc},'_AGU.png'];
while isafile(fname)
    n = n+1; n_str = ['.',num2str(n)];
    fname = [ACCP_pngs,'OQS_wwo_adj_alpha_',SFC{srfc},n_str,'_AGU.png'];
end
saveas(gcf,fname);
pause(2)
close(gcf);
...
o=2; clear sq
sq(1)= subplot(3,1,1);
bb = bar([1:length(lay)],squeeze(OQSadj(lay,:,1,srfc,2)),'barwidth',.7,'edgecolor','none'); ylim([-.15,1]);
hold('on');sq(1).ColorOrderIndex = 1;
...
sq(2)= subplot(3,1,2);
bb = bar([1:length(lay)],squeeze(OQSadj(lay,:,2,srfc,2)),'barwidth',.7,'edgecolor','none'); ylim([-.15,1]);
hold('on');sq(1).ColorOrderIndex = 1;
...
sq(3) = subplot(3,1,3);
bb = bar([1:length(lay)],squeeze(OQSadj(lay,:,3,srfc,2)),'barwidth',.7,'edgecolor','none'); ylim([-.15,1]);
hold('on');sq(1).ColorOrderIndex = 1;
...
bb = bar([1:length(prf)],squeeze(OQSadj(prf,:,1,srfc,2)),'barwidth',.7,'edgecolor','none'); ylim([-.15,1]);
hold('on');sq(1).ColorOrderIndex = 1;
...
bb = bar([1:length(prf)],squeeze(OQSadj(prf,:,2,srfc,2)),'barwidth',.7,'edgecolor','none'); ylim([-.15,1]);
hold('on');sq(1).ColorOrderIndex = 1;
...
bb = bar([1:length(prf)],squeeze(OQSadj(prf,:,3,srfc,2)),'barwidth',.7,'edgecolor','none'); ylim([-.15,1]);
hold('on');sq(1).ColorOrderIndex = 1;
...
bar([1:length(layr)],mean(squeeze(OQSadj(layr,:,1,srfc,:)),3),'barwidth',.7,'edgecolor','none'); ylim([0,1]);
hold(sq(1),'on');  sq(1).ColorOrderIndex = 1; 
bar([1:length(layr)],max(squeeze(OQSadj(layr,:,1,srfc,:)),[],3),'barwidth',.7,'edgecolor','k','facecolor','none'); ylim([0,1]);
hold(sq(1),'on');  sq(1).ColorOrderIndex = 1; 
bar([1:length(layr)],min(squeeze(OQSadj(layr,:,1,srfc,:)),[],3),'barwidth',.7,'edgecolor','k','facecolor','none'); ylim([0,1]);
...
bar([1:length(prof)],mean(squeeze(OQSadj(prof,:,1,srfc,:)),3),'barwidth',.7,'edgecolor','none'); ylim([0,1]);
hold(sq(2),'on');  sq(2).ColorOrderIndex = 1; 
bar([1:length(prof)],max(squeeze(OQSadj(prof,:,1,srfc,:)),[],3),'barwidth',.7,'edgecolor','k','facecolor','none'); ylim([0,1]);
hold(sq(2),'on');  sq(2).ColorOrderIndex = 1; 
bar([1:length(prof)],min(squeeze(OQSadj(prof,:,1,srfc,:)),[],3),'barwidth',.7,'edgecolor','k','facecolor','none'); ylim([0,1]);
...
bar([1:length(layr)],mean(squeeze(OQSadj(layr,:,2,srfc,:)),3),'barwidth',.7,'edgecolor','none'); ylim([0,1]);
hold(sq(3),'on');  sq(3).ColorOrderIndex = 1; 
bar([1:length(layr)],max(squeeze(OQSadj(layr,:,2,srfc,:)),[],3),'barwidth',.7,'edgecolor','k','facecolor','none'); ylim([0,1]);
hold(sq(3),'on');  sq(3).ColorOrderIndex = 1; 
bar([1:length(layr)],min(squeeze(OQSadj(layr,:,2,srfc,:)),[],3),'barwidth',.7,'edgecolor','k','facecolor','none'); ylim([0,1]);
...
bar([1:length(prof)],mean(squeeze(OQSadj(prof,:,2,srfc,:)),3),'barwidth',.7,'edgecolor','none'); ylim([0,1]);
hold(sq(4),'on');  sq(4).ColorOrderIndex = 1; 
bar([1:length(prof)],max(squeeze(OQSadj(prof,:,2,srfc,:)),[],3),'barwidth',.7,'edgecolor','k','facecolor','none'); ylim([0,1]);
hold(sq(4),'on');  sq(4).ColorOrderIndex = 1; 
bar([1:length(prof)],min(squeeze(OQSadj(prof,:,2,srfc,:)),[],3),'barwidth',.7,'edgecolor','k','facecolor','none'); ylim([0,1]);
