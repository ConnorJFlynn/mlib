function plot_OQ_Co_C1(OQS_C0, OQS_C1)
% plot_OQ_Co_C1(OQS_C0, OQS_C1)
% Developed to show difference between original treatment with no Cirrus
% from current approach using NAD = mean(NADBC0 ,NADLC1) and NAN = mean(NANLC0,NANLC1)
...
bar([1:length(prof)],squeeze(OQSadj(prof,:,2,srfc,1)),'barwidth',1,'edgecolor','none'); ylim([0,1]);
...
bar([1:length(prof)],squeeze(OQSadj(prof,:,1,srfc,1)),'barwidth',1,'edgecolor','none'); ylim([0,1]);
% set(gca,'position',[0.6293    0.7357    0.3301    0.18]);
set(gca,'xtick',[1:length(prof)]);set(gca, 'ytick',[0:.2:1])
set(gca,'XTickLabel',xtt); %set(sql(2),'xaxislocation','top');
set(gca,'XTickLabelRot',0); set(gca,'FontSize',10);
...
bar([1:length(prof)],squeeze(OQSadj(prof,:,2,srfc,3)),'barwidth',1,'edgecolor','none'); ylim([0,1]);
% set(gca,'position',[0.6293    0.7357    0.3301    0.18]);
set(gca,'xtick',[1:length(prof)]);set(gca, 'ytick',[0:.2:1])
set(gca,'XTickLabel',xtt); %set(sql(2),'xaxislocation','top');
set(gca,'XTickLabelRot',0); set(gca,'FontSize',10);
...
bar([1:length(prof)],squeeze(OQSadj(prof,:,1,srfc,3)),'barwidth',1,'edgecolor','none'); ylim([0,1]);
% set(gca,'position',[0.6293    0.7357    0.3301    0.18]);
set(gca,'xtick',[1:length(prof)]);set(gca, 'ytick',[0:.2:1])
set(gca,'XTickLabel',xtt); %set(sql(2),'xaxislocation','top');
set(gca,'XTickLabelRot',0); set(gca,'FontSize',10);
...
bar([1:length(prof)],squeeze(OQSadj(prof,:,2,srfc,4)),'barwidth',1,'edgecolor','none'); ylim([0,1]);
% set(gca,'position',[0.6293    0.7357    0.3301    0.18]);
set(gca,'xtick',[1:length(prof)]);set(gca, 'ytick',[0:.2:1])
...
bar([1:length(prof)],squeeze(OQSadj(prof,:,1,srfc,4)),'barwidth',1,'edgecolor','none'); ylim([0,1]);
% set(gca,'position',[0.6293    0.7357    0.3301    0.18]);
set(gca,'xtick',[1:length(prof)]);set(gca, 'ytick',[0:.2:1])
set(gca,'XTickLabel',prof_x); %set(sql(2),'xaxislocation','top');
set(gca,'XTickLabelRot',30); set(gca,'FontSize',10);
...
n_str = '';n = 1;
fname = [ACCP_pngs,'OQSadj_Prof_',SFC{srfc},n_str,'.png'];
while isafile(fname)
