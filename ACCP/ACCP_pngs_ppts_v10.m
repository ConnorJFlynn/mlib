function ACCP_pngs_ppts_v11(gv, gv2)
...
plot_ACCP_QMR_V8(QIS,MER,RMS,gv,'LNDD','RES1', [PPT_path pptname]);
plot_ACCP_QMR_V8(QIS,MER,RMS,gv,'LNDV','RES1', [PPT_path pptname])
plot_ACCP_QMR_V8(QIS,MER,RMS,gv,'OCEN','RES1', [PPT_path pptname]);
...
plot_ACCP_cases_V7(QIS,MER,RMS,gv,'LNDD','RES1', [PPT_path pptname]);
plot_ACCP_cases_V7(QIS,MER,RMS,gv,'LNDV','RES1', [PPT_path pptname]);
plot_ACCP_cases_V7(QIS,MER,RMS,gv,'OCEN','RES1', [PPT_path pptname]);
...
if isadir([ACCP_set, 'M1',filesep])
    ...
    plot_ACCP_QMR_V8(QIS,MER,RMS,gv2,'LNDD','RES1', [PPT_path pptname]);
    plot_ACCP_QMR_V8(QIS,MER,RMS,gv2,'LNDV','RES1', [PPT_path pptname])
    plot_ACCP_QMR_V8(QIS,MER,RMS,gv2,'OCEN','RES1', [PPT_path pptname]);
    ...
    saveas(gcf,[ACCP_pngs,png_name2]);close(gcf);
    ppt_add_slide_no_title([PPT_path pptname], [ACCP_pngs,png_name2]);
    plot_ACCP_cases_V7(QIS,MER,RMS,gv2,'LNDD','RES1', [PPT_path pptname]);
    plot_ACCP_cases_V7(QIS,MER,RMS,gv2,'LNDV','RES1', [PPT_path pptname]);
    plot_ACCP_cases_V7(QIS,MER,RMS,gv2,'OCEN','RES1', [PPT_path pptname]);
