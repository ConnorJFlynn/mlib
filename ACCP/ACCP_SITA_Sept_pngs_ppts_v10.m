function ACCP_SITA_Sept_pngs_ppts_v10(gv, gv2)
...
%   Replicate 
% Calls:
%   read_all_SITA_Sept_samplefiles_v4
%   plot_SITA_Sept_cases_v3
...
[QIS, MER, RMS,VERS,files] = read_all_SITA_Sept_samplefiles_v4(ACCP_set);
...
plot_SITA_Sept_cases_v3(QIS,gv,'LAND',obs,'RES1', [PPT_path pptname2]);
plot_SITA_Sept_cases_v3(QIS,gv,'OCEN',obs,'RES1', [PPT_path pptname2]);
...
if isadir([ACCP_set, '_M1',filesep])
    ...
    plot_SITA_Sept_cases_v3(QIS,gv2,'LAND',obs,'RES1', [PPT_path pptname2]);
    plot_SITA_Sept_cases_v3(QIS,gv2,'OCEN',obs,'RES1', [PPT_path pptname2]);
