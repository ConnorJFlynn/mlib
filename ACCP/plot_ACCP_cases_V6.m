function plot_ACCP_cases_V6(QIS,MER,RMS,gv,sfc,reso,pptname)
% plot_AACP_cases_V6(QIS,MER,RMS,gv,srfc,res)
...
% V6: removed attempts to force common y-limits for some panels
dv = 4.0;
