function [QIS, MER, RMS, VERS, files] = read_all_SITA_Sept_samplefiles_v6(dpath)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%Propagate OU SSP2 into SSG3 for NADLC1, NANLC1, NADLC2, NANLC2
QIS(:,5,:,4,5:8,:,:) = QIS(:,5,:,3,5:8,:,:);
MER(:,5,:,4,5:8,:,:) = MER(:,5,:,3,5:8,:,:); 
RMS(:,5,:,4,5:8,:,:) = RMS(:,5,:,3,5:8,:,:);
