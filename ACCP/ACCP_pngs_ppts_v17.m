function ACCP_pngs_ppts_v17(gv, gv2)
...
[QI_adj, Q_mean, Q_std,Q_min,Q_max] = stats_ACCP_Q_adjust_V2_nopng(QIS,gv)
...
[QI_adj] = plot_ACCP_Q_adjust_V2_nopng(QIS,gv,'RES1', [PPT_path pptname3]);
pltf = ["SSP0", "SSP1", "SSP2", "SSG3"];
write_AQS(QI_adj,pltf);
[QI_adj_] = plot_ACCP_Q_adjust_V2(QIS,gv,'RES1', [PPT_path pptname3]);
% pltf = ["SSP0", "SSP1", "SSP2", "SSG3"];
% write_AQS(QI_adj,pltf);
...
plot_ACCP_QMR_V13(QIS,MER,RMS,gv,'OCEN','RES1', [PPT_path pptname]);
plot_ACCP_QMR_V13(QIS,MER,RMS,gv,'LNDD','RES1', [PPT_path pptname]);
plot_ACCP_QMR_V13(QIS,MER,RMS,gv,'LNDV','RES1', [PPT_path pptname])
