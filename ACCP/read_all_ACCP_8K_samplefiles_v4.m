function [QIS, MER, RMS, VERS, files] = read_all_ACCP_8K_samplefiles_v5(dpath)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%     try
    ...
    if isempty(plt_ind)&&(strcmpi(plt,'SSP3')||strcmpi(plt,'GPM')) % Catch SSG3 mislabeled as SSP3
        plt_ind = 4;
    end
