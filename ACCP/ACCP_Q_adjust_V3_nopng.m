function [QI_adj, Q_noadj] = ACCP_Q_adjust_V3_nopng(QIS,gv,reso)
% [QI_adj,Q_noadj] =ACCP_Q_adj_V3(QIS,gv,reso)
...
% V3: Added Q_noadj as output, removed pptname as input (unused)
