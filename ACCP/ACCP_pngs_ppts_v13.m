function ACCP_pngs_ppts_v13(gv, gv2)
...
plot_ACCP_QMR_V11(QIS,MER,RMS,gv,'LNDD','RES5', [PPT_path pptname]);
plot_ACCP_QMR_V11(QIS,MER,RMS,gv,'LNDV','RES1', [PPT_path pptname])
plot_ACCP_QMR_V11(QIS,MER,RMS,gv,'OCEN','RES1', [PPT_path pptname]);
...
if isadir([ACCP_set, 'M1',filesep])
    ...
    plot_ACCP_QMR_V11(QIS,MER,RMS,gv2,'LNDD','RES1', [PPT_path pptname]);
    plot_ACCP_QMR_V11(QIS,MER,RMS,gv2,'LNDV','RES1', [PPT_path pptname])
    plot_ACCP_QMR_V11(QIS,MER,RMS,gv2,'OCEN','RES1', [PPT_path pptname]);
