function [QIS, MER, RMS] = read_all_ACCP_8K_samplefiles_v4(dpath)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% v4, fixed mislabel of DSR6g as DRSg
...
%     try
    ...
    if isempty(plt_ind)&&strcmpi(plt,'SSP3') % Catch SSG3 mislabeled as SSP3
        plt_ind = 4;
    end
