function ACCP_SITA_Sept_pngs_ppts_v2(gv, gv2)
...
plot_SITA_Sept_QMR_v2(QIS,MER,RMS,gv,'LAND',obs,'RES1', [PPT_path pptname]);
plot_SITA_Sept_QMR_v2(QIS,MER,RMS,gv,'OCEN',obs,'RES1', [PPT_path pptname]);
