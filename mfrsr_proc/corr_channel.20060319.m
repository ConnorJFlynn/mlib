...
%channel ch contains time, th, dif, dh, zen_angle, az_angle
%det_corrs contains det_sens, offset, gain
%angle_corrs contains zenith angle with SN and WE corrections
...
% end
zen_angle_WE = ch.zen_angle .* (ch.az_angle<=180) ...
    - ch.zen_angle .* (ch.az_angle>180);
zen_angle_SN = ch.zen_angle .* ((ch.az_angle<=90)|(ch.az_angle>270)) ... 
    - ch.zen_angle .* ((ch.az_angle>90)&(ch.az_angle<=270));

WE_cor = interp1(angle_corrs.zen_angle, angle_corrs.WE, zen_angle_WE);
SN_cor = interp1(angle_corrs.zen_angle, angle_corrs.SN, zen_angle_SN);
