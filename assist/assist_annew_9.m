...
assist_0 = rad_cal_def_no_ref(assist);
%%
...
[Cnu_,c2 ,c4] = ApplyFFOVCorr(assist.chA.cxs.x, assist.chA.spc.y(in(1),:),0.0225)
%%
figure; plot(assist.chA.cxs.x, assist.chA.spc.y(assist.logi.Sky_F,:),'-')
