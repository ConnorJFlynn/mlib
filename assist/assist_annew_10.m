...
% ZPD Values:
% A Forward ZPD Location: 16385 =>  = 2
% A Reverse ZPD Location: 16392 => = 9
% B Forward ZPD Location: 16381 = -2
% B Reverse ZPD Location: 16386 = 3
%(-16384 + 1 + ZPD_location) = ZPD_location -16383
% 
% Different ZPD values for A and B seems strange… but it is due to the sampling of the instrument. 
% Taken from the maximum absolute value of HBB used for calibration. 
...
% NLC_A_A2 = 4.033475e-008
% NLC_A_IHLAB = -7.736925e004
% NLC_A_ICLAB = 3.831425e003

% nlc.a2 = (4.6828e-008);
% nlc.IHLAB=(-80443);
% nlc.ICLAB=(96455);
nlc.a2 = (8.033475e-008);
% nlc.a2 = (4.6828e-008);
% nlc.a2 = (8.033475e-009);

nlc.IHLAB=(-7.736925e004);
nlc.ICLAB=(3.831425e003);

% From Connor's run of NLC_fit of Feb Thunderhead LN2 test, run 4
% Run number: 1 
%  I_H=-79123.328 
%  I_A=2601.152 
%  I_C=85137.680 
