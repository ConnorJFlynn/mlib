...
assist.chA.flynn_mat.zpdLocation(s) = assist.chA.edgar_mat.subfiles{s}.subfileHeader.zpdLocation;
   ...
   disp('Hey!  No zpd location in this file');
end
...
assist.chA.flynn_mat.zpdValue(s) = assist.chA.edgar_mat.subfiles{s}.subfileHeader.zpdValue;
   ...
   disp('Hey!  No zpd value in this file');
end
...
assist.chA.cxs.HBB_F_offset = a2.*RawIgm2RawSpc(assist.chA.igm.HBB_F.^2);
assist.chA.cxs.HBB_R_offset = a2.*RawIgm2RawSpc(assist.chA.igm.HBB_R.^2);
assist.chA.cxs.CBB_F_offset = a2.*RawIgm2RawSpc(assist.chA.igm.CBB_F.^2);
assist.chA.cxs.CBB_R_offset = a2.*RawIgm2RawSpc(assist.chA.igm.CBB_R.^2);
assist.chA.cxs.Sky_F_offset = a2.*RawIgm2RawSpc(assist.chA.igm.Sky_F.^2);
assist.chA.cxs.Sky_R_offset = a2.*RawIgm2RawSpc(assist.chA.igm.Sky_R.^2);
