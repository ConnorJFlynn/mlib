...
if abbs==hbbs && hbbs==ln2s
   ...
   for Run_number = Nb_of_Runs:-1:1
      ...
      sub2 = (CalSet_HA_F.x>200&CalSet_HA_F.x<460);
      sub1 = (CalSet_HA_F.x>1900&CalSet_HA_F.x<2200);
      sub2 = sub1;
      
      A2_F_raw(Run_number) = mean(a2_F_raw(sub2));
      A2_F_pc(Run_number) = mean(a2_F_pc(sub2));
      ...
      A2_R_raw(Run_number) = mean(a2_R_raw(sub2));
      A2_R_pc(Run_number) = mean(a2_R_pc(sub2));
