function [y_] = zpd_reflect_odd(x,y,shift_zpd);
% Usage: [y] = zpd_reflect_odd(x,y,shift_zpd)
% Similar to fftshift except:
% 1. Centers the supplied igm.y by reflecting across the identified zpd
% 2. Truncates to leave zpd at (length+1)/2 position
% 3. Swap the centered igm about the center
% Generates an igram with odd length.
