function assist = assist_annew(pname)% ASSIST annew
%    Compare result of flipping the reverse scan end to end and
%    combining the forward and reverse igrams rather than averaging the
%    actual spectra: Done.  Compares well in ch A, little less well in
%    Ch B. Not sure why, not important to resolve.  Moving on.
% Determine radiance calibration
% Assess flatness and complex fraction of responsivity and of offset
% in cts and radiance space.
%  Done!  Now understand that offset in cts is essentially the
%  detector responsivity times the second port BB emission.
%  Offset in cts is just the second port BB emission.
...
circshifted.M.y = fftshift((zpd_circshift(assist.F.chA.x,assist.F.chA.y,zpd_shift_F)+fliplr(zpd_circshift(assist.R.chA.x,assist.R.chA.y,zpd_shift_R)))./2);
...
plot(assist.F.chA.x, [circshifted.F.y(1,:);fliplr(circshifted.R.y(1,:))],'-');
...
assist.M.chA.cxs.y = fft((zpd_circshift(assist.F.chA.x,assist.F.chA.y,zpd_shift_F)+fliplr(zpd_circshift(assist.R.chA.x,assist.R.chA.y,zpd_shift_R)))./2,[],2);
%%
figure(2); 

s1(1) = subplot(2,1,1);
plot(assist.chA.cxs.x(chA_good), real(assist.F.chA.cxs.y(1,chA_good)), 'r', assist.chA.cxs.x(chA_good),imag(assist.F.chA.cxs.y(1,chA_good)),'c');
title('forward')
legend('real','imag');
s1(2) = subplot(2,1,2); 
plot(assist.chA.cxs.x(chA_good), real(assist.R.chA.cxs.y(1,chA_good)), 'r', assist.chA.cxs.x(chA_good),imag(assist.R.chA.cxs.y(1,chA_good)),'c');
title('reverse')
legend('real','imag');
% s1(3) = subplot(3,1,3); 
% plot(assist.chA.cxs.x(chA_good), real(assist.M.chA.cxs.y(1,chA_good)), 'r', assist.chA.cxs.x(chA_good),imag(assist.M.chA.cxs.y(1,chA_good)),'c');
% title('merged')
% legend('real','imag');
% linkaxes(s1,'x');
...
% plot(assist.chA.cxs.x(chA_good), real([(assist.F.chA.cxs.y(1,chA_good));assist.R.chA.cxs.y(1,chA_good); assist.M.chA.cxs.y(1,chA_good)]),'-');
% title('Real')
% legend('forward','reverse','merged');
...
% plot(assist.chA.cxs.x(chA_good), imag([(assist.F.chA.cxs.y(1,chA_good));assist.R.chA.cxs.y(1,chA_good); assist.M.chA.cxs.y(1,chA_good)])./...
%  real([(assist.F.chA.cxs.y(1,chA_good));assist.R.chA.cxs.y(1,chA_good); assist.M.chA.cxs.y(1,chA_good)])  ,'-');
% title('Imag fraction')
% legend('forward','reverse','merged');
...
circshifted.M.y = fftshift((zpd_circshift(assist.F.chB.x,assist.F.chB.y,zpd_shift_F)+fliplr(zpd_circshift(assist.R.chB.x,assist.R.chB.y,zpd_shift_R)))./2);
%%
...
ax(2) = subplot(2,1,2);
% plot(assist.F.chB.x, [circshifted.F.y(1,:);fliplr(circshifted.R.y(1,:));circshifted.M.y(1,:)],'-');
% legend('forward','reverse','merged')
...
assist.M.chB.cxs.y = fft((zpd_circshift(assist.F.chB.x,assist.F.chB.y,zpd_shift_F)+fliplr(zpd_circshift(assist.R.chB.x,assist.R.chB.y,zpd_shift_R)))./2,[],2);
...
legend('real','imag');
s1(3) = subplot(3,1,3); 
plot(assist.chB.cxs.x(chB_good), real(assist.M.chB.cxs.y(1,chB_good)), 'r', assist.chB.cxs.x(chB_good),imag(assist.M.chB.cxs.y(1,chB_good)),'c');
title('merged')
legend('real','imag');
linkaxes(s1,'x');
...
plot(assist.chB.cxs.x(chB_good), real([(assist.F.chB.cxs.y(1,chB_good));assist.R.chB.cxs.y(1,chB_good); assist.M.chB.cxs.y(1,chB_good)]),'-');
% title('Real')
legend('forward','reverse','merged');
...
plot(assist.chB.cxs.x(chB_good), imag([(assist.F.chB.cxs.y(1,chB_good));assist.R.chB.cxs.y(1,chB_good); assist.M.chB.cxs.y(1,chB_good)])./...
 abs([(assist.F.chB.cxs.y(1,chB_good));assist.R.chB.cxs.y(1,chB_good); assist.M.chB.cxs.y(1,chB_good)])  ,'-');
% title('Imag fraction')
legend('forward','reverse','merged');
...
in_spec.y = assist.M.chA.cxs.y;
out_spec_M_chA = RadiometricCalibration_3(in_spec, assist.chA.cal_M);
out_post_M_chA.y = (out_spec_F.y + out_spec_R.y)./2;
...
in_spec.y = assist.M.chB.cxs.y;
out_spec_M_chB = RadiometricCalibration_3(in_spec, assist.chB.cal_M);
out_post_M_chB.y = (out_spec_F.y + out_spec_R.y)./2;
%%
...
figure(9);
sb9(1) = subplot(2,1,1);
plot(assist.chA.cxs.x(posA), real([out_spec_M_chA.y(ind,posA);out_post_M_chA.y(ind,posA)]), '-');
title('Calibration of  premerged and postmerged results ch A');
ylabel('RU');
legend('premerge','postmerge');
sb9(2) = subplot(2,1,2);
plot(assist.chA.cxs.x(posA), real([out_spec_M_chA.y(ind,posA)-out_post_M_chA.y(ind,posA)])./real([out_spec_M_chA.y(ind,posA)+out_post_M_chA.y(ind,posA)])./2, '-');
legend('Relative difference premerged-postmerged');
plot(assist.chA.cxs.x(posA), real([out_spec_M_chA.y(ind,posA)-out_post_M_chA.y(ind,posA)]), '-');
legend('Absolute difference premerged-postmerged');
ylabel('ru')
xlabel('wavenumber');
linkaxes(sb9,'x')
%%
figure(10);
sb10(1) = subplot(2,1,1);
plot(assist.chA.cxs.x(posA), imag([out_spec_M_chA.y(ind,posA);out_post_M_chA.y(ind,posA)]), '-');
title('Calibration of premerged and postmerged results Ch A');
ylabel('imag(RU)');
legend('premerge','postmerge');
sb10(2) = subplot(2,1,2);
plot(assist.chA.cxs.x(posA), [imag(out_spec_M_chA.y(ind,posA))./real(out_spec_M_chA.y(ind,posA));...
   imag(out_post_M_chA.y(ind,posA))./real(out_post_M_chA.y(ind,posA))], '-');
legend('premerge','postmerge');
title('imag frac =img/real')
ylabel('unitless')
xlabel('wavenumber');
linkaxes(sb10,'x')
%%
...
figure(19);
sb9(1) = subplot(2,1,1);
plot(assist.chB.cxs.x(posB), real([out_spec_M_chB.y(ind,posB);out_post_M_chB.y(ind,posB)]), '-');
title('Calibration of premerged and postmerged results ch B');
ylabel('RU');
legend('premerge','postmerge');
sb9(2) = subplot(2,1,2);
plot(assist.chB.cxs.x(posB), real([out_spec_M_chB.y(ind,posB)-out_post_M_chB.y(ind,posB)])./real([out_spec_M_chB.y(ind,posB)+out_post_M_chB.y(ind,posB)])./2, '-');
legend('Relative difference premerged-postmerged');
plot(assist.chB.cxs.x(posB), real([out_spec_M_chB.y(ind,posB)-out_post_M_chB.y(ind,posB)]), '-');
legend('Absolute difference premerged-postmerged');
ylabel('ru')
...
figure(20);
sb10(1) = subplot(2,1,1);
plot(assist.chB.cxs.x(posB), imag([out_spec_M_chB.y(ind,posB);out_post_M_chB.y(ind,posB)]), '-');
title('Calibration of premerged and postmerged results Ch A');
ylabel('imag(RU)');
legend('premerge','postmerge');
sb10(2) = subplot(2,1,2);
plot(assist.chB.cxs.x(posB), [imag(out_spec_M_chB.y(ind,posB))./real(out_spec_M_chB.y(ind,posB));...
   imag(out_post_M_chB.y(ind,posB))./real(out_post_M_chB.y(ind,posB))], '-');
legend('premerge','postmerge');
title('imag frac =img/real')
ylabel('unitless')
xlabel('wavenumber');
...
in_spec.y = assist.M.chA.cxs.y(assist.F.logi.A,:);
ABB_M = CoaddData(in_spec);
in_spec.y = assist.M.chA.cxs.y(assist.F.logi.H,:);
HBB_M = CoaddData(in_spec);
...
assist.chA.cal_M = CreateCalibrationFromCXS_(HBB_M,  273.15+(T_hot_R+T_hot_F)./2, ABB_M,  273.15+(T_cold_R+T_cold_F)./2);
...
in_spec.y = assist.M.chB.cxs.y(assist.F.logi.A,:);
ABB_M = CoaddData(in_spec);
in_spec.y = assist.M.chB.cxs.y(assist.F.logi.H,:);
HBB_M = CoaddData(in_spec);
...
assist.chB.cal_M = CreateCalibrationFromCXS_(HBB_M,  273.15+(T_hot_R+T_hot_F)./2, ABB_M,  273.15+(T_cold_R+T_cold_F)./2);
