...
%Apply Rowe responsivity criteria, and then FFOV correction
% Then output derived products.
toc
...
mt.vdata.y_data = assist.down.chA.T_bt(assist.down.isSky,xl_A)';
mt.vdata.x_axis = assist.chA.cxs.x(xl_A)';
