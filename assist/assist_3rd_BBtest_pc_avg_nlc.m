function assist = assist_3rd_BBtest_pc_avg_nlc % ASSIST annew
...
assist.chA.spc.y__(assist.logi.F,:) = RadiometricCalibration_4(assist.chA.cxs.y(assist.logi.F,:), assist.chA.cal_F__);
assist.chA.spc.y__(assist.logi.R,:) = RadiometricCalibration_4(assist.chA.cxs.y(assist.logi.R,:), assist.chA.cal_R__);

assist.chB.spc.y__(assist.logi.F,:) = RadiometricCalibration_4(assist.chB.cxs.y(assist.logi.F,:), assist.chB.cal_F__);
assist.chB.spc.y__(assist.logi.R,:) = RadiometricCalibration_4(assist.chB.cxs.y(assist.logi.R,:), assist.chB.cal_R__);
...
assist.down.chA.cxs.F = downsample(assist.chA.cxs.y(assist.logi.F,:),N);
assist.down.chA.mrad.F = downsample(assist.chA.mrad.y(assist.logi.F,:),N);
assist.down.chA.mrad.F__ = downsample(assist.chA.mrad.y__(assist.logi.F,:),N);
assist.down.chA.var.F = downvariance(assist.chA.mrad.y(assist.logi.F,:),N);
...
assist.down.chB.cxs.F = downsample(assist.chB.cxs.y(assist.logi.F,:),N);
assist.down.chB.mrad.F = downsample(assist.chB.mrad.y(assist.logi.F,:),N);
assist.down.chB.mrad.F__ = downsample(assist.chB.mrad.y__(assist.logi.F,:),N);
assist.down.chB.var.F = downvariance(assist.chB.mrad.y(assist.logi.F,:),N);
...
assist.down.chB.cxs.R = downsample(assist.chB.cxs.y(assist.logi.R,:),N);
assist.down.chB.mrad.R = downsample(assist.chB.mrad.y(assist.logi.R,:),N);
assist.down.chB.mrad.R__ = downsample(assist.chB.mrad.y__(assist.logi.R,:),N);
assist.down.chB.var.R = downvariance(assist.chB.mrad.y(assist.logi.R,:),N);

% Combine F and R
assist.down.chA.mrad.y = (assist.down.chA.mrad.F + assist.down.chA.mrad.R)./2;
assist.down.chA.mrad.y__ = (assist.down.chA.mrad.F__ + assist.down.chA.mrad.R__)./2;

assist.down.chA.var.y = (assist.down.chA.var.F  + assist.down.chA.var.R);
chA_emis = interp1(assist.emis.x, assist.emis.y, assist.chA.cxs.x, 'linear','extrap');
chA_emis = ones(size(assist.down.chA.mrad.y,1),1)*chA_emis;
