function assist = assist_annew_13 % ASSIST annew
...
while n<=N-2
    ...
    if (~exist([pname, dstem{1},'ann_HC.csv'],'file')&&~exist([pname, dstem{1},'chA_HC.nc'],'file')&&~exist([pname, dstem{1},'chB_HC.nc'],'file')&&...
            ~exist([pname, dstem{2},'ann_SKY.csv'],'file')&&~exist([pname, dstem{2},'chA_SKY.nc'],'file')&&~exist([pname, dstem{2},'chB_SKY.nc'],'file')&&...
            ~exist([pname, dstem{3},'ann_CH.csv'],'file')&&~exist([pname, dstem{3},'chA_CH.nc'],'file')&&~exist([pname, dstem{3},'chB_CH.nc'],'file'))||...
            (~exist([pname, dstem{1},'ann_CH.csv'],'file')&&~exist([pname, dstem{1},'ann_HC.csv'],'file')&&~exist([pname, dstem{1},'chA_HC.nc'],'file')&&~exist([pname, dstem{1},'chB_HC.nc'],'file')&&...st([pname, dstem{1},'chA_CH.nc'],'file')&&~exist([pname, dstem{1},'chB_CH.nc'],'file')&&...
            ~exist([pname, dstem{2},'ann_SKY.csv'],'file')&&~exist([pname, dstem{2},'chA_SKY.nc'],'file')&&~exist([pname, dstem{2},'chB_SKY.nc'],'file')&&...
            ~exist([pname, dstem{3},'ann_HC.csv'],'file')&&~exist([pname, dstem{3},'chA_HC.nc'],'file')&&~exist([pname, dstem{3},'chB_HC.nc'],'file'))
        n = n + 1;
...
%From Michel pre-TMP
nlc.a2 = 4.4592e-08;
nlc.IHLAB = -187770.1847;
nlc.ICLAB = 306480.2721;
nlc.IALAB = 19104.9025; % Not used in SSEC NLC correction?
