function [inp,line_num] = gen_sky_inp_4STAR_ALM(star)
...
% It differs from gen_sky_inp_4STAR not so much in the structure of the
...
% Adding logic to identify corresponding SA angles in ALM legs
% Exclude unmatched or poor symmetry points
% Compute averaged value
% Assign final preprocessing anet level
...
% Now apply anet screens to remove SA < 3.5, any angles for which any WL
% fails the consistency check, and then compute averages of unique
% remaining pairs. 
