...
int validate_inputs(spa_data *spa)
{
    ...
    if ((spa->minute      < 0    ) || (spa->minute      >= 60 )) return 5;
    ...
    {
        if (fabs(spa->atmos_refract) > 10 ) return 16;
    }

    return 0;
}
///////////////////////////////////////////////////////////////////////////////////////////////
double julian_day (int year, int month, int day, int hour, int minute, float second, float tz)
{
...
double ecliptic_mean_obliquity(double jme)
{
    ...
    // sjb
    double result = 0;
    result = u*(    5.79 + u*2.45);
    result = u*(   27.87 + result);
    result = u*(    7.12 + result);
    result = u*(  -39.05 + result);
    result = u*( -249.67 + result);
    result = u*(  -51.38 + result);
    result = u*( 1999.25 + result);
    result = u*(   -1.55 + result);
    result = u*(-4680.96 + result);
    result += 84381.448;
