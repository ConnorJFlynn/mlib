...
Si_out = fopen([kurucz_path, 'sws_solar_ESR.MNewKur.Si.20110101.20150501.txt'],'w'); %W.M-2.nm-1
...
In_out = fopen([kurucz_path, 'sws_solar_ESR.MNewKur.InGaAs.20110101.20150501.txt'],'w'); %W.M-2.nm-1
