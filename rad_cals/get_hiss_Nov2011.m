function [archi] = get_hiss_Nov2011(in)
...
if fid>2
    ...
    figure; plot(archi.nm, [archi.lamps_12,archi.lamps_9,archi.lamps_6, archi.lamps_3,archi.lamps_2,archi.lamps_1,archi.lamps_p5],'-');
    legend('12 lamps','9 lamps','6 lamps','3 lamps','2 lamps','1 lamp','0.5 lamp');
