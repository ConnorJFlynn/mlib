function [vis_cal, nir_cal] = Radiance_cals_SASZe_auto_hiss(sas_pname);
% [vis_cal, nir_cal] = Radiance_cals_SASZe_auto_hiss(pname)
...
% save([sas_pname, SAS_unit,'.',datestr(lamp_cal.nir.time(1),'yyyy_mm_dd.HHMM'),'.mat'],'-struct','cal');
save([sas_pname, SAS_unit,'_radcals.All_lamps.',datestr(lamp_cal.nir.time(1),'yyyy_mm_dd.HHMM'),'.mat'],'-struct','cal')
return