function [vis_resp, nir_resp] = radcal_Ze2_TASZERS_Oriel_20240326
% [vis_resp, nir_resp] = radcal_Ze2_TASZERS_Oriel_20240326
...
for v = length(vints) %:-1:1
    ...
    unblocked_lighta = mean(vis.rate(ubblk_light_ij(1:2:end),:));
    unblocked_lightb = mean(vis.rate(ubblk_light_ij(2:2:end),:));
