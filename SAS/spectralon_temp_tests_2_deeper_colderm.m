...
save([bare_fiber.pname, 'ReferenceFiber.mat'],'-struct','bare_fiber');
clear bare_fiber
%%
...
save([button_tempRamp.pname, 'SpectralonFiber_QFS_Button_tempRamp.mat'],'-struct','button_tempRamp');

clear button_tempRamp bare_fiber
spec = load(['D:\case_studies\SAS\testing_and_characterization\2013_08_15.SpectralonResponse_vsTemp_2ndRun_n40C\ReferenceFiber\ReferenceFiber.mat']);
...
%%
spec2 = load(['D:\case_studies\SAS\testing_and_characterization\2013_08_15.SpectralonResponse_vsTemp_2ndRun_n40C\SpectralonFiber_QFS_Button_tempRamp\SpectralonFiber_QFS_Button_tempRamp.mat']);;
