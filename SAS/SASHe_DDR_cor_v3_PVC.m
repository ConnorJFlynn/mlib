...
sas = load(['D:\epc\epcsashevisaodM1.c1.ddr_filt.20230113_20230810.mat']);
...
figure; plot(...
   sas_ddr(7,good5), mfr.vdata.direct_diffuse_ratio_filter5(good5)./sas_ddr(7,good5),'.',...
   sas_ddr(6,good4), mfr.vdata.direct_diffuse_ratio_filter4(good4)./sas_ddr(6,good4),'.',...
   sas_ddr(5,good3), mfr.vdata.direct_diffuse_ratio_filter3(good3)./sas_ddr(5,good3),'.',...
   sas_ddr(4,good2), mfr.vdata.direct_diffuse_ratio_filter2(good2)./sas_ddr(4,good2),'.',...
   sas_ddr(2,good1), mfr.vdata.direct_diffuse_ratio_filter1(good1)./sas_ddr(2,good1),'.');
legend('filter 5','filter 4','filter 3','filter 2','filter 1');
