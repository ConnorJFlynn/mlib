...
% SN 0911134U1: CCD
% SN 0911129U1: CMOS
CCD34 = SAS_read_ava(getfullname_('*.csv','ava','Select Zenith collimator spectra for CCD34'));
...
%%
CCDx37 = SAS_read_ava(getfullname_('*.csv','ava','Select Zenith collimator spectra for CCDx37'));
...
title('Zenith DN-darks');
%%
NIR_46 = SAS_read_ava(getfullname_('*.csv','ava','Select Zenith collimator spectra for NIR_46'));
