...
Y = Y.*(yf);
x_str = 'MFRSR D2D'; y_str = 'SASHe D2D'; nm_str = [vers,' 415 nm'];
...
yf = interp1(ddr_corr.ddr, ddr_corr.fac, Y,'linear','extrap');
Y = Y.*(yf);
x_str = 'MFRSR D2D'; y_str = 'SASHe D2Dv2'; nm_str = [vers,' 500 nm'];
plot_ddr(X,Y,x_str, y_str, site_str, nm_str, fig_path);
...
yf = interp1(ddr_corr.ddr, ddr_corr.fac, Y,'linear','extrap');
Y = Y.*(yf);
x_str = 'MFRSR D2D'; y_str = 'SASHe D2Dv2'; nm_str = [vers,' 615 nm'];
plot_ddr(X,Y,x_str, y_str, site_str, nm_str, fig_path);
...
yf = interp1(ddr_corr.ddr, ddr_corr.fac, Y,'linear','extrap');
Y = Y.*(yf);
x_str = 'MFRSR D2D'; y_str = 'SASHe D2Dv2'; nm_str = [vers,' 675 nm'];
plot_ddr(X,Y,x_str, y_str, site_str, nm_str, fig_path);
...
yf = interp1(ddr_corr.ddr, ddr_corr.fac, Y,'linear','extrap');
Y = Y.*(yf);
x_str = 'MFRSR D2D'; y_str = 'SASHe D2Dv2'; nm_str = [vers,' 870 nm'];
plot_ddr(X,Y,x_str, y_str, site_str, nm_str, fig_path);
