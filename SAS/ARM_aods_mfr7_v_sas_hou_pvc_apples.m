function blah % Current situation with HOU comparisons:
...
y_str = 'SASHe AOD'; x_str = 'Aeronet AOD'; nm_str = '1020 nm';
plot_aod(X,Y,x_str, y_str, site_str, nm_str,fig_path);
...
y_str = 'SASHe AOD'; x_str = 'Aeronet AOD'; nm_str = '1640 nm';
plot_aod(X,Y,x_str, y_str, site_str, nm_str,fig_path);
...
x_str = 'MFRSR D2D'; y_str = 'SASHe D2D'; nm_str = '415 nm';
...
x_str = 'MFRSR D2D'; y_str = 'SASHe D2D'; nm_str = '500 nm';
plot_ddr(X,Y,x_str, y_str, site_str, nm_str, fig_path);
...
x_str = 'MFRSR D2D'; y_str = 'SASHe D2D'; nm_str = '615 nm';
plot_ddr(X,Y,x_str, y_str, site_str, nm_str, fig_path);
...
x_str = 'MFRSR D2D'; y_str = 'SASHe D2D'; nm_str = '675 nm';
plot_ddr(X,Y,x_str, y_str, site_str, nm_str, fig_path);
...
x_str = 'MFRSR D2D'; y_str = 'SASHe D2D'; nm_str = '870 nm';
plot_ddr(X,Y,x_str, y_str, site_str, nm_str, fig_path);

if isfield(mfr.vdata, 'direct_diffuse_ratio_filter7');
   X = mfr.vdata.direct_diffuse_ratio_filter7(minns);
   Z = sasn.vdata.wavelength;
   Y = sasn.vdata.direct_normal_transmittance(2,sinnm)./sasn.vdata.diffuse_transmittance(2,sinnm);
keep = X>0 & Y>0 & ...
   sasn.vdata.direct_normal_transmittance(2,sinnm)>0 & sasn.vdata.diffuse_transmittance(2,sinnm)>0 & ...
   mfr.vdata.direct_normal_narrowband_filter7(minns)>0 & mfr.vdata.diffuse_hemisp_narrowband_filter7(minns)>0;
X = X(keep); Y = Y(keep);

   x_str = 'MFRSR D2D'; y_str = 'SASHe D2D'; nm_str = '1625 nm';
   plot_ddr(X,Y,x_str, y_str, site_str, nm_str, fig_path);
end
...
function plot_aod(X,Y,x_str, y_str, site_str, nm_str, pname);
      t_str = ['Aerosol Optical Depth ',nm_str];
      % Evaluate from here...
