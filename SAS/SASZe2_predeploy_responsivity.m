function SGP_Ze2_predeploy_responsivity
% And now computing responsivity of Ze specs from ARM sphere radiances
% First, load the SAS data files:
pname = 'C:\case_studies\SAS\Cals pre deployment\Ze2_0911134U1_0911146U1\25ms\';
visname = '20101214_0911134U1.csv';
...
%%
pname = 'C:\case_studies\SAS\Cals pre deployment\Ze2_0911134U1_0911146U1\25ms\';
nirname = '20101214_0911146U1.csv';
Ze_nir_1001069U1 = SAS_read_ava([pname, nirname]);
% Trim rec > 333
fields = fieldnames(Ze_nir_1001069U1);
for f = 3:length(fields)-2
    Ze_nir_1001069U1.(fields{f})(334:end) = [];
end
Ze_nir_1001069U1.spec(334:end,:) = [];
...
%%
figure; plot(1:length(Ze_nir_1001069U1.time),Ze_nir_1001069U1.spec(:,75),'-') 

%%
figure; plot(serial2Hh(Ze_nir_1001069U1.time(Ze_nir_1001069U1.Shuttered_0==0)),Ze_nir_1001069U1.spec(Ze_nir_1001069U1.Shuttered_0==0,25:25:200),'-') 
