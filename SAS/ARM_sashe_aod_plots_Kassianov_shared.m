function ARM_sashe_aod_plots_Kassianov_shared % Current situation with HOU comparisons:
...
if isfield(mfr.vdata, 'aerosol_optical_depth_filter2')
   ...
   if isfield(mfr.vdata,'aerosol_optical_depth_filter7')
      Y = sasn.vdata.aerosol_optical_depth(6,sinnm);
