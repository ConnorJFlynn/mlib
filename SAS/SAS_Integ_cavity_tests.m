function ins = SAS_Integ_cavity_tests(infile)
% This totally unfinished file was used to read two files Albert collected
% to help assess the value of adding an integrating cavity in front of a
...
figure; 
% s(1) = subplot(2,1,1);
lines = plot(degs, down.sig(:,20:125)' , '-'); 
%
%
