...
% Start over for a minute...
% Generate code to read raw SWS data and corresponding raw SAS-Ze data for
% both spectrometers.
% Generate dark-subtracted spectra for both.
% Pin together at local noon and look at agreement of several spectral
% lines over the day.
%
% View time-series for several spectral lines
%    For period when both were operating, as close to July 18 as possible.
%    Check DQ plots and DataGrid to find clear sky data for this comparison
%    
% Separately, apply responsivity calibrations to both systems especially
% near noon.  Look at overall spectral agreement.
