...
close all
%%
abe.vars.ext_mean_norm = abe.vars.ext_mean;
abe.vars.ext_mean_norm.atts.long_name.data = 'normalized extinction profiles, per AOT bin, per season';
%Calculating the min ext for each profile upto 6.0 kms in a particular
%season.
%Take the difference of the min ext upto 6.0 kms
...
for season = 1:1:(abe.dims.season.length)
       ...
       abe.vars.ext_mean_norm.data(season,1,:) = new_ext1;
       %========================================================
       ext2 = zeros(1, 177);
       ...
       abe.vars.ext_mean_norm.data(season,2,:) = new_ext2;
        %========================================================
       ext3 = zeros(1, 177);
       ...
       abe.vars.ext_mean_norm.data(season,3,:) = new_ext3;
        %========================================================
       ext4 = zeros(1, 177);
       ...
       abe.vars.ext_mean_norm.data(season,5,:) = new_ext5;
        %========================================================
       ext6 = zeros(1, 177);
       ...
       abe.vars.ext_mean_norm.data(season,6,:) = new_ext6;
        %========================================================
       ext7 = zeros(1, 177);
       ...
       abe.vars.ext_mean_norm.data(season,7,:) = new_ext7;
        %========================================================
      figure;
...
newname = ['aerosolbe1turn_parameter_norm'];
newcdf = [newname, '.cdf'];

ancsave(abe, newcdf);
%%
%==========================================================================
% Calculate the min per aod bin upto 7 kms
%==========================================================================
