...
ylabel('aod')
xl = xlim; xlim(xl);
title(['Best-Estimate AOD ',datestr(abe.time(1),'mmm yyyy')]);
...
title(['Relative Humidity from MergeSonde ',datestr(abe.time(1),'mmm yyyy')]);
...
xlabel(['day of year ',datestr(abe.time(1),'yyyy')]);
ylabel('height [km AGL]')
title(['Best-Estimate Aerosol Extinction Profiles ',datestr(abe.time(1),'mmm yyyy')]);
...
xlim(xl);
ylim([1,1.25.*max(aipfrh.vars.ratio_85by40_Bs_R_1um_2p.data(ainc))]);
title(['frh 85%/40% ratio at 1 um ',datestr(abe.time(1),'mmm yyyy')]);
...
ylabel('g [dry sfc]')
xlim(xl);
title(['asymmetry parameter "g" at 1 um, low RH, sfc ',datestr(abe.time(1),'mmm yyyy')]);
ylim([0,1]);
...
ylabel('bsf [dry sfc]')
xlim(xl);
title(['backscatter fraction at 1 um, low RH, sfc ',datestr(abe.time(1),'mmm yyyy')]);
ylim([0,.4]);
...
ylabel('Bs [1/km]')
xlim(xl);
title(['Total scattering coefficient at 1 um, low RH, sfc ',datestr(abe.time(1),'mmm yyyy')]);
...
ylabel('Bbs [1/km]')
xlim(xl);
title(['Hemispheric backscattering coefficient at 1 um, low RH, sfc ',datestr(abe.time(1),'mmm yyyy')]);
...
ylabel('Ba [1/km]')
xlim(xl);
title(['Absorption coefficient at 1 um, low RH, sfc ',datestr(abe.time(1),'mmm yyyy')]);
...
xlabel(['day of year ',datestr(abe.time(1),'yyyy')]);
ylabel('height [km AGL]')
title(['Single Scattering Albedo Profiles ',datestr(abe.time(1),'mmm yyyy')]);
...
xlabel(['day of year ',datestr(abe.time(1),'yyyy')]);
ylabel('height [km AGL]')
title(['Asymmetry Parameter Profiles ',datestr(abe.time(1),'mmm yyyy')]);
