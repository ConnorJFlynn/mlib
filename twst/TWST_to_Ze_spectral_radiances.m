...
twst = rd_twst_nc4; % TWST-EN0011_20230415;
...
figure; plot(twst.wl_A, 1e3.*twst.zenrad_A(:,10600), 'b-',zevis.vdata.wavelength-3.5, 1.15.*2.*zevis.vdata.zenith_radiance(:,10600),'r-',...
...
figure; plot(twst.wl_A, 1e3.*mean(twst.zenrad_A(:,tl_),2), 'b-',zevis.vdata.wavelength-3.5, 1.15.*2.*mean(zevis.vdata.zenith_radiance(:,tl_),2),'r-',...
...
datestr(datenum(2023,4,15,19,46,2))
