/*
 * @(#)mclmcrrt.h    generated by: makeheader 5.1.5  Tue Jul  7 17:04:17 2009
 *
...
/* Map original name to unique proxy layer name. */
#undef mclInitializeComponentInstanceWithCtfFileH
#define mclInitializeComponentInstanceWithCtfFileH mclInitializeComponentInstanceWithCtfFileH_proxy
...
/* Map original name to unique proxy layer name. */
#undef mclGetOutputHandlerBaseMethods
#define mclGetOutputHandlerBaseMethods mclGetOutputHandlerBaseMethods_proxy
...
/* Map original name to unique proxy layer name. */
#undef mclGetDefaultPrintHandler
#define mclGetDefaultPrintHandler mclGetDefaultPrintHandler_proxy
...
/* Map original name to unique proxy layer name. */
#undef mclInitializeComponentInstanceExH
#define mclInitializeComponentInstanceExH mclInitializeComponentInstanceExH_proxy
...
/* Map original name to unique proxy layer name. */
#undef mclGetDefaultErrorHandler
#define mclGetDefaultErrorHandler mclGetDefaultErrorHandler_proxy
...
/* Map original name to unique proxy layer name. */
#undef mclInitializeComponentInstanceWithEmbeddedCTFH
#define mclInitializeComponentInstanceWithEmbeddedCTFH mclInitializeComponentInstanceWithEmbeddedCTFH_proxy
...
/* Map original name to unique proxy layer name. */
#undef mclMakeOutputHandler
#define mclMakeOutputHandler mclMakeOutputHandler_proxy
...
/* Map original name to unique proxy layer name. */
#undef mclInitializeComponentInstanceH
#define mclInitializeComponentInstanceH mclInitializeComponentInstanceH_proxy
...
EXTERN_C
bool mclInitializeComponentInstanceWithCtfFileH_proxy(HMCRINSTANCE *a0, 
    const mclComponentData *a1, bool a2, mccComponentType a3, 
    mccTargetType a4, mclOutputHandlerPtr a5, mclOutputHandlerPtr a6, 
...
#ifdef __cplusplus /* Only available in C++ */
EXTERN_C
mclOutputHandler_methods * mclGetOutputHandlerBaseMethods_proxy();
#endif /* __cplusplus */
...
EXTERN_C
void mclSetDefaultPrintHandlers_proxy(mclOutputHandler a0, 
    mclOutputHandler a1);
...
EXTERN_C
mclOutputHandler mclGetDefaultPrintHandler_proxy();
...
EXTERN_C
bool mclInitializeComponentInstanceExH_proxy(HMCRINSTANCE *a0, 
    const mclComponentData *a1, const mclComponentOptions *a2, bool a3, 
    mccComponentType a4, mccTargetType a5, mclOutputHandlerPtr a6, 
    mclOutputHandlerPtr a7);
...
EXTERN_C
mclOutputHandler mclGetDefaultErrorHandler_proxy();
...
EXTERN_C
bool mclInitializeComponentInstanceWithEmbeddedCTFH_proxy(
    HMCRINSTANCE *a0, const mclComponentData *a1, bool a2, 
    mccComponentType a3, mccTargetType a4, mclOutputHandlerPtr a5, 
    mclOutputHandlerPtr a6, long unsigned int a7, void *a8);
...
EXTERN_C
mclOutputHandler mclMakeOutputHandler_proxy(mclOutputHandlerFcn a0);
...
EXTERN_C
bool mclInitializeComponentInstanceH_proxy(HMCRINSTANCE *a0, 
    const mclComponentData *a1, bool a2, mccComponentType a3, 
    mccTargetType a4, mclOutputHandlerPtr a5, mclOutputHandlerPtr a6);
