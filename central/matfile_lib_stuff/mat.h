/*
 * @(#)mat.h    generated by: makeheader 5.1.5  Mon Jun 29 15:47:16 2009
 *
 ...
 */
EXTERN_C int matPutVariable(MATFile * pMF, const char * name, const mxArray * pA);
 ...
 * Return zero for success, nonzero for error.
 */
EXTERN_C int matPutVariableAsGlobal(MATFile * pMF, const char * name, const mxArray * pA);
