function [good] = hmadf_span(Io, N, thresh); 
%[good] = hmadf_span(Io, N, thresh);  
...
% higher N values is less restrictive.  Lower N values is more stringent
if ~exist('thresh','var')
    thresh = 6;
end
good = isfinite(Io);
