function [good] = mldf_span(Io, N, thresh); 
%[good] = MLDF_span(Io, N, thresh);  
% Applies an Median Least Deviation filter to a collection of values over a span of N points.
