...
NormalComments = {...
    ...
    'ASSOCIATED_DATA: This file contains a correction from STP to ambient conditions that requires the IWG1 data.  Filled with missings if unavailable.';...
    ...
    'OTHER_COMMENTS: Scattering coefficients have been corrected to STP.  Convert to ambient my multiplying by included density correction factor';...
    };
