function sws_polarizer_test_2011_12_15_test1
...
% This test uses GT polarizer and has the SWS window in place.   
...
test_dir = 'C:\case_studies\SWS\sws_pol_integ_sphere_at_PNNL\Test_1_GT_with_window\';
...
%%
pol.deg = [0:20:360];
pol.time(1) = datenum('2011-12-14 22:04', 'yyyy-mm-dd HH:MM')
...
%%
figure; plot([1:length(sws.time)], sws.In_spec(10,:),'-')
%%
