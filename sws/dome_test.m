...
figure; subplot(2,1,1); plot((sws_1.time(sws_1.shutter==0)),sws_1.Si_cps(150,sws_1.shutter==0),'.-')
%%
...
clear ax
ax(1) = subplot(2,1,1); 
plot([1:length(sws_1.time)],sws_1.Si_cps([60,95,147],:),'.-')
% plot(sws_1.time(sws_1.shutter==0),sws_1.Si_cps([60,95,147],(sws_1.shutter==0)),'.-')
% datetick
title(['Non-dark cps for selected Si pixels for ',sprintf('%2.1f degrees',mean(sws_1.zen))]);
...
yl = ylim;
ax(2) = subplot(2,1,2); 
plot([1:length(sws_1.time)],sws_1.In_cps([17,60,125,230],:),'.-');
% plot(sws_1.time(sws_1.shutter==0),sws_1.In_cps([17,60,125,230],(sws_1.shutter==0)),'.-');
% datetick
...
mark1 = 212; % dome on, unshaded start
mark2 = 328; % dome on, unshaded end
mark3 = 329; % done on, shaded start
mark4 = 446; % dome on, shaded end
mark5 = 727; % dome off, unshaded start
mark6 = 747; % dome off, unshaded end

mark7 = 749; % dome off, shaded start
mark8 = 866; % dome off, shaded end

sws_1.unshaded1 = (sws_1.time>=sws_1.time(mark1))&(sws_1.time<=sws_1.time(mark2));
sws_1.shaded1 = (sws_1.time>=sws_1.time(mark3))&(sws_1.time<=sws_1.time(mark4));
sws_1.unshaded2 = (sws_1.time>=sws_1.time(mark5))&(sws_1.time<=sws_1.time(mark6));
sws_1.shaded2 = (sws_1.time>=sws_1.time(mark7))&(sws_1.time<=sws_1.time(mark8));
%%
figure
clear ax
ax(1) = subplot(2,1,1); 
plot(sws_1.time((sws_1.unshaded1|sws_1.shaded1)&sws_1.shutter==0),sws_1.Si_cps([60,95,147],((sws_1.unshaded1|sws_1.shaded1)&sws_1.shutter==0)),'.-')
% plot(sws_1.time(sws_1.shutter==0),sws_1.Si_cps([60,95,147],(sws_1.shutter==0)),'.-')
datetick('keeplimits')
title(['With dome, non-dark cps for selected Si pixels for ',sprintf('%2.1f degrees',mean(sws_1.zen))]);
legend(sprintf('%1.f nm',sws_1.Si_lambda(60)),sprintf('%1.f nm',sws_1.Si_lambda(95)),sprintf('%1.f nm',sws_1.Si_lambda(147)));
xlabel('time (UTC)')
ylabel('counts/ms')
yl = ylim;
ax(2) = subplot(2,1,2); 
plot(sws_1.time((sws_1.unshaded1|sws_1.shaded1)&sws_1.shutter==0),sws_1.In_cps([17,60,125,230],((sws_1.unshaded1|sws_1.shaded1)&sws_1.shutter==0)),'.-');
% plot(sws_1.time(sws_1.shutter==0),sws_1.In_cps([17,60,125,230],(sws_1.shutter==0)),'.-');
datetick('keeplimits')
legend(sprintf('%1.f nm',sws_1.In_lambda(17)),sprintf('%1.f nm',sws_1.In_lambda(60)),...
   sprintf('%1.f nm',sws_1.In_lambda(125)),sprintf('%1.f nm',sws_1.In_lambda(230)));
...
figure
ax2(1) = subplot(2,1,1); 
plot(sws_1.time((sws_1.unshaded2|sws_1.shaded2)&sws_1.shutter==0),sws_1.Si_cps([60,95,147],((sws_1.unshaded2|sws_1.shaded2)&sws_1.shutter==0)),'.-')
% plot(sws_1.time(sws_1.shutter==0),sws_1.Si_cps([60,95,147],(sws_1.shutter==0)),'.-')
datetick('keeplimits')
title(['No dome, non-dark cps for selected Si pixels for ',sprintf('%2.1f degrees',mean(sws_1.zen))]);
legend(sprintf('%1.f nm',sws_1.Si_lambda(60)),sprintf('%1.f nm',sws_1.Si_lambda(95)),sprintf('%1.f nm',sws_1.Si_lambda(147)));
xlabel('time (UTC)')
ylabel('counts/ms')
yl = ylim;
ax2(2) = subplot(2,1,2); 
plot(sws_1.time((sws_1.unshaded2|sws_1.shaded2)&sws_1.shutter==0),sws_1.In_cps([17,60,125,230],((sws_1.unshaded2|sws_1.shaded2)&sws_1.shutter==0)),'.-');
% plot(sws_1.time(sws_1.shutter==0),sws_1.In_cps([17,60,125,230],(sws_1.shutter==0)),'.-');
datetick('keeplimits')
legend(sprintf('%1.f nm',sws_1.In_lambda(17)),sprintf('%1.f nm',sws_1.In_lambda(60)),...
   sprintf('%1.f nm',sws_1.In_lambda(125)),sprintf('%1.f nm',sws_1.In_lambda(230)));
...
Si_fig = figure; ax(1) = subplot(3,1,1); plot(sws_1.Si_lambda, mean(sws_1.Si_cps(:,sws_1.shaded1&sws_1.shutter==0),2),'b',sws_1.Si_lambda, mean(sws_1.Si_cps(:,(sws_1.unshaded1)&(sws_1.shutter==0)),2),'r');
legend('shaded','unshaded');
title(['SWS Si shading test, SZA=',sprintf('%2.1f deg, ',mean(sws_1.zen)), datestr(mean(sws_1.time(sws_1.shaded1)),' yyyy-mm-dd HH:MM UTC')]);
ylabel('cps, dark subtracted');
yl = ylim; ylim([0,yl(2)]);
ax(2) = subplot(3,1,2); plot(sws_1.Si_lambda, (mean(sws_1.Si_cps(:,(sws_1.unshaded1)&(sws_1.shutter==0)),2)-mean(sws_1.Si_cps(:,sws_1.shaded1&sws_1.shutter==0),2)),'k');
ylabel('diff (cps)');
yl = ylim; ylim([0,yl(2)]);
ax(3) = subplot(3,1,3); plot(sws_1.Si_lambda, 100*(mean(sws_1.Si_cps(:,(sws_1.unshaded1)&(sws_1.shutter==0)),2)-mean(sws_1.Si_cps(:,sws_1.shaded1&sws_1.shutter==0),2))./(mean(sws_1.Si_cps(:,(sws_1.unshaded1)&(sws_1.shutter==0)),2)),'g');
ylabel('diff (%)');
xlabel('wavelength (nm)');
ylim([0,100]);
%

In_fig = figure; ax(1) = subplot(3,1,1); plot(sws_1.In_lambda, mean(sws_1.In_cps(:,sws_1.shaded1&sws_1.shutter==0),2),'b',sws_1.In_lambda, mean(sws_1.In_cps(:,(sws_1.unshaded1)&(sws_1.shutter==0)),2),'r');
legend('shaded','unshaded');
title(['SWS InGaAs shading test, SZA=',sprintf('%2.1f deg, ',mean(sws_1.zen)), datestr(mean(sws_1.time(sws_1.shaded1)),' yyyy-mm-dd HH:MM UTC')]);
ylabel('cps, dark subtracted');
yl = ylim; ylim([0,yl(2)]);
ax(2) = subplot(3,1,2); plot(sws_1.In_lambda, (mean(sws_1.In_cps(:,(sws_1.unshaded1)&(sws_1.shutter==0)),2)-mean(sws_1.In_cps(:,sws_1.shaded1&sws_1.shutter==0),2)),'k');
ylabel('diff (cps)');
yl = ylim; ylim([0,yl(2)]);
ax(3) = subplot(3,1,3); plot(sws_1.In_lambda, 100*(mean(sws_1.In_cps(:,(sws_1.unshaded1)&(sws_1.shutter==0)),2)-mean(sws_1.In_cps(:,sws_1.shaded1&sws_1.shutter==0),2))./(mean(sws_1.In_cps(:,(sws_1.unshaded1)&(sws_1.shutter==0)),2)),'g');
ylabel('diff (%)');
xlabel('wavelength (nm)')
ylim([0,100]);
%%
...
dstr = datestr(mean(sws_1.time(sws_1.shaded1)),'yyyymmdd_HHMM.');
fstem = ['SWS_shading_test.']; 
ext = '.png';
saveas(Si_fig,[pname,fstem,'domed_Si.',SZA,dstr,ext],'png');
saveas(In_fig,[pname,fstem,'domed_InGaAs.',SZA,dstr,ext],'png');
save([pname,fstem,SZA,dstr,'mat'],'-mat')
%%
!!
Si_fig2 = figure; ax(1) = subplot(3,1,1); plot(sws_1.Si_lambda, mean(sws_1.Si_cps(:,sws_1.shaded2&sws_1.shutter==0),2),'b',sws_1.Si_lambda, mean(sws_1.Si_cps(:,(sws_1.unshaded2)&(sws_1.shutter==0)),2),'r');
legend('shaded','unshaded');
title(['Undomed SWS Si shading test, SZA=',sprintf('%2.1f deg, ',mean(sws_1.zen)), datestr(mean(sws_1.time(sws_1.shaded2)),' yyyy-mm-dd HH:MM UTC')]);
ylabel('cps, dark subtracted');
yl = ylim; ylim([0,yl(2)]);
ax(2) = subplot(3,1,2); plot(sws_1.Si_lambda, (mean(sws_1.Si_cps(:,(sws_1.unshaded2)&(sws_1.shutter==0)),2)-mean(sws_1.Si_cps(:,sws_1.shaded2&sws_1.shutter==0),2)),'k');
ylabel('diff (cps)');
yl = ylim; ylim([0,yl(2)]);
ax(3) = subplot(3,1,3); plot(sws_1.Si_lambda, 100*(mean(sws_1.Si_cps(:,(sws_1.unshaded2)&(sws_1.shutter==0)),2)-mean(sws_1.Si_cps(:,sws_1.shaded2&sws_1.shutter==0),2))./(mean(sws_1.Si_cps(:,(sws_1.unshaded2)&(sws_1.shutter==0)),2)),'g');
ylabel('diff (%)');
xlabel('wavelength (nm)');
ylim([0,100]);
%

In_fig2 = figure; ax(1) = subplot(3,1,1); plot(sws_1.In_lambda, mean(sws_1.In_cps(:,sws_1.shaded2&sws_1.shutter==0),2),'b',sws_1.In_lambda, mean(sws_1.In_cps(:,(sws_1.unshaded2)&(sws_1.shutter==0)),2),'r');
legend('shaded','unshaded');
title(['Undomed SWS InGaAs shading test, SZA=',sprintf('%2.1f deg, ',mean(sws_1.zen)), datestr(mean(sws_1.time(sws_1.shaded2)),' yyyy-mm-dd HH:MM UTC')]);
ylabel('cps, dark subtracted');
yl = ylim; ylim([0,yl(2)]);
ax(2) = subplot(3,1,2); plot(sws_1.In_lambda, (mean(sws_1.In_cps(:,(sws_1.unshaded2)&(sws_1.shutter==0)),2)-mean(sws_1.In_cps(:,sws_1.shaded2&sws_1.shutter==0),2)),'k');
ylabel('diff (cps)');
yl = ylim; ylim([0,yl(2)]);
ax(3) = subplot(3,1,3); plot(sws_1.In_lambda, abs(100*(mean(sws_1.In_cps(:,(sws_1.unshaded2)&(sws_1.shutter==0)),2)-mean(sws_1.In_cps(:,sws_1.shaded2&sws_1.shutter==0),2))./(mean(sws_1.In_cps(:,(sws_1.unshaded2)&(sws_1.shutter==0)),2))),'g');
ylabel('diff (%)');
xlabel('wavelength (nm)')
ylim([0,100]);
%%
...
[pname, fstem,ext] = fileparts(sws_1.filename);
SZA = sprintf('%2.1fdeg. ',mean(sws_1.zen));
dstr = datestr(mean(sws_1.time(sws_1.shaded2)),'yyyymmdd_HHMM.');
fstem = ['undomed_SWS_shading_test.']; 
ext = '.png';
saveas(Si_fig2,[pname,fstem,'undomed_Si.',SZA,dstr,ext],'png');
saveas(In_fig2,[pname,fstem,'undomed_InGaAs.',SZA,dstr,ext],'png');
save([pname,fstem,SZA,dstr,'mat'],'-mat')
%%
