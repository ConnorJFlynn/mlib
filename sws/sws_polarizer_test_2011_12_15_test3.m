...
% This test uses GT polarizer and has the SWS window removed. 
...
test_dir = 'C:\case_studies\SWS\sws_pol_integ_sphere_at_PNNL\Test_3_GT_wo_window\';
...
%%
pol.deg = [0:20:360];
pol.time(1) = datenum('2011-12-14 22:56', 'yyyy-mm-dd HH:MM')
