...
atm_temp(out_range)=interp1(alt,std_temp,range(out_range),'nearest','extrap');
atm_press(out_range)=interp1(alt,std_press,range(out_range),'nearest','extrap');